...
public class PlayerTagged extends Timer implements Listener {
	...
	public void onEntityDamageByEntity(EntityDamageByEntityEvent event) {
        ...
        if (damager != null && damager != event.getEntity()) {
        	...
        	super.cooldown(player, Defaults.PVP_TIMER_MAX_TIME, ColorRegex.colors(super.plugin.getConfig().getString(Paths.PVP_TIMER_TIME)));
        	super.cooldown(damager, Defaults.PVP_TIMER_MAX_TIME, ColorRegex.colors(super.plugin.getConfig().getString(Paths.PVP_TIMER_TIME)));
        }
    }
	...
	public void onEntityDeath(EntityDeathEvent event) {
    	...
    	super.cooldown(player, 0, ColorRegex.colors(super.plugin.getConfig().getString(Paths.PVP_TIMER_TIME)));
	}
}
